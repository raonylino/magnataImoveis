...
export const empreendimentos: Empreendimento[] = [
  {
    ...
    whatsappMessage: "Olá! Encontrei o Parque 1453 no site da Magnata Imóveis e gostaria de saber mais sobre as unidades.",
    highlights: ["248 apartamentos", "2 dormitórios", "42m²", "Varanda gourmet", "Lazer de clube", "Piscina, academia, espaço gourmet e brinquedoteca", "Pet place e quadra"],
  ...
  },
  {
    ...
    description: ["O OPEN é um empreendimento da Construtora Vital no Jardins de Florença, em Poços de Caldas, com apartamentos de 2 dormitórios e áreas de lazer no rooftop.", "A página oficial informa início das obras previsto para o segundo semestre de 2026 e prazo máximo de obra de 36 meses. A indicação de unidades a partir de R$ 235.000,00 é dinâmica e deve ser confirmada antes de qualquer decisão."],
    commercialNotice: "Valores sujeitos a alteração e análise de crédito. Consulte disponibilidade e condições atuais com o corretor.",
  },
];
